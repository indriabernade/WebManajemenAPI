...
class APIsPage extends State<APIs> {
  ...
  void dispose() {
    ...
    // Dispose all the other scroll controllers
    super.dispose();
  }
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (response.statusCode == 200) {
                                      ...
                                      var request = http.Request(
                                          'DELETE',
                                          Uri.parse(
                                              'https://tyk-api.kube.myrepublic.net.id/tyk/keys/${usersFiltered[index].request_signing.key_id}'));
                ...
                DataCell(IconButton(
                    ...
                    onPressed: () {
                      ...
                      final apiController = TextEditingController(
                          text: usersFiltered[index].api_id);
